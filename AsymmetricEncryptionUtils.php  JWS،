...
class AsymmetricEncryptionUtils
{

    protected JWEBuilder $jweBuilder;

    protected JWEDecrypter $jweDecrypter;
     ...
     * @return string
     */
    public function encrypt($payload, $keyId, $publicCertificatePath): string
    {
        // Our key.
        $jwk = JWKFactory::createFromCertificateFile($publicCertificatePath);
     ...
     * @return string|null
     */
    public function decrypt($jweToken, $privateKeyPath): ?string
    {
        // Our key.
    ...
    /**
     * This method sign a JWE and return a JWS token using a private key
     * @param $jweToken
     * @param $signingKid
     * @param $signingPrivateKeyPath
     * @return string
     */
    public function signJwe($jweToken, $signingKid, $signingPrivateKeyPath): string
    {
        // Our key.
        $jwk = JWKFactory::createFromKeyFile($signingPrivateKeyPath);
     ...
     * @param $jwsToken
     * @param $signingPublicCertificatePath
     * @return bool true if successful else false
     */
    public function verifyJws($jwsToken, $signingPublicCertificatePath): bool
    {
        // Our key.
        $jwk = JWKFactory::createFromCertificateFile($signingPublicCertificatePath);
